...
Sub create_csv_load_table(sheet_name As String, max_num_field_per_row As Integer)
    ...
    Debug.Print TabOver(2) & "stmt = " & Chr(34) & "insert into " & sheet_name & "(" & Chr(34)
    For i = 1 To index
            Debug.Print TabOver(2) & "stmt += " & Chr(34) & fieldnames(i) & Chr(34)
    Next i
    
    
    For i = 1 To index
        If (i = 1) Then
            Debug.Print TabOver(2) & "stmt += " & Chr(34) & " values (";
            Debug.Print question(i) & Chr(34)
        Else
            Debug.Print TabOver(2) & "stmt += " & Chr(34) & question(i) & Chr(34)
        End If
    Next i
    
    
    Debug.Print
    Debug.Print TabOver(2) & "for entry in reader:"
    Debug.Print
    Debug.Print TabOver(3) & "try:"
    Debug.Print
